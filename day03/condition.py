...
# [프로그램 시작 ---프로그램 끝 ]
# 1. 숫자 입력을 받고, 해당 순자가 100이면, 100을 입력 하셨습니다
print("프로그램 시작!")
num = int(input("숫자 입력:"))
if num == 100:
    print("100을 입력하셨습니다.")
...
# 2. 숫자 입력을 받고, 해당 숫자가 20~30이면, 20에서 30 사이의 숫자를 입력하셨습니다.
print("프로그램 시작!")
num = int(input("숫자 입력:"))
if num > 20 and num < 30:
    print(" 20에서 30 사이의 숫자를 입력하셨습니다")
print("프로그램 끝 ")
...
# ! and "IT" 포함되지 않으면, 올바르게 비밀번호 입력 하지 않았습니다.
print("프로그램 시작!")
num = input("IT 가 들어가나요?")
if num in "IT":
    print("올바르게 비밀번호를 입력하였습니다")
print("프로그램 끝 ")
